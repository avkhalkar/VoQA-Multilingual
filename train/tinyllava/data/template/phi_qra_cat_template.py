...
@register_template('phi_qra_cat')
@dataclass
class PhiQRACatTemplate(Template):
    ...
    format_assistant: "Formatter" = StringFormatter(slot="CAT" + ": " + "{{content}}" + "<|endoftext|>")
    system: "Formatter" = EmptyFormatter(slot=system+" ")
    separator: "Formatter" = EmptyFormatter(slot=[' CAT: ', '<|endoftext|>'])
