...
class ModelArguments:
    ...
    text_vision_tower: Optional[str] = field(default='')
    connector_type: str = field(default='linear')
    text_vision_connector_type: str = field(default='linear')
...
class DataArguments:
    ...
    text_image_folder: Optional[str] = field(default=None)
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    tune_type_text_vision_tower: str = field(default="frozen") # support only: frozen, full
    tune_type_text_vision_connector: str = field(default="full") # support only: frozen, full
