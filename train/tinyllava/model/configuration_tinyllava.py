...
class TinyLlavaConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        connector_type = None,
        text_vision_connector_type = None,
        text_config=None,
        hidden_size=2048,
        vocab_size=32000,
        ignore_index=-100,
        image_token_index=32000,
        text_vision_hidden_size = 1024, # text vision tower
        pad_token = None,
        pad_token_id = None,
        ...
        **kwargs
        ...
        self.text_vision_connector_type = text_vision_connector_type
        ...
        self.text_vision_hidden_size = text_vision_hidden_size
    ...
    def load_from_config(self, config):
        ...
        self.text_vision_connector_type = getattr(config, 'text_vision_connector_type', None)
