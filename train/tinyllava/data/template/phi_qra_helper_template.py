...
@register_template('phi_qra_helper')
@dataclass
class PhiQRAHelpertTemplate(Template):
    ...
    format_assistant: "Formatter" = StringFormatter(slot="HELPER" + ": " + "{{content}}" + "<|endoftext|>")
    system: "Formatter" = EmptyFormatter(slot=system+" ")
    separator: "Formatter" = EmptyFormatter(slot=[' HELPER: ', '<|endoftext|>'])
